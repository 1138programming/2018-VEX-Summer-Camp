#pragma config(Motor,  port2,           LeftDriveMotor, tmotorVex393_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port9,          RightDriveMotor, tmotorVex269_HBridge, openLoop)
